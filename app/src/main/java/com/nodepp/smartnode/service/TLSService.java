...
//        accountHelper.setTestHost("113.108.64.238", false);    // 不走sso
    ...
    public void initPhonePwdLoginService(Context context,
                                         ...
                                         EditText txt_pwd,
                                         Button btn_login) {
        phonePwdLoginService = new PhonePwdLoginService(context, txt_phone, txt_pwd, btn_login);
    }
    ...
    public int smsRegAskCode(String countryCode, String phoneNumber, TLSSmsRegListener listener) {
        return accountHelper.TLSSmsRegAskCode(Utils.getWellFormatMobile(countryCode, phoneNumber), listener);
    }
    ...
    public int TLSPwdRegAskCode(String countryCode, String phoneNumber, TLSPwdRegListener listener) {
        return accountHelper.TLSPwdRegAskCode(Utils.getWellFormatMobile(countryCode, phoneNumber), listener);
    }


    public int TLSPwdResetAskCode(String countryCode, String phoneNumber, TLSPwdResetListener listener) {
        return accountHelper.TLSPwdResetAskCode(Utils.getWellFormatMobile(countryCode, phoneNumber), listener);
    }

...
/**
 *  该类用于保存TLS SDK、QQ SDK、WeChat SDK相关的配置信息
 */
public class TLSConfiguration {
    public static long SDK_APPID;
    public static int ACCOUNT_TYPE = 6838;
    ...
    // QQ SDK
    public static String QQ_APP_ID = "1105767210";
    public static String QQ_APP_KEY = "BntG3zdM9g0avqC6";

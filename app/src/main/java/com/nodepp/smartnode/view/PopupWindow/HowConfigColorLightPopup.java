 ...
 */
public class HowConfigColorLightPopup extends PopupWindow {
    ...
    public HowConfigColorLightPopup(Context context) {
        this(context, LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT);
        initUI();
    }

    @SuppressWarnings("deprecation")
    public HowConfigColorLightPopup(Context context, int width, int height) {
        ...
        setContentView(LayoutInflater.from(mContext).inflate(
                R.layout.popup_how_to_config, null));
    }
